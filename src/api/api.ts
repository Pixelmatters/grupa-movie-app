...
export const getRatedMovies = (sessionId: string) =>
  exec(`account/id/rated/movies?session_id=${sessionId}`, Method.GET);

export const getWatchList = (sessionId: string) =>
  exec(`account/id/watchlist/movies?session_id=${sessionId}`, Method.GET);

export const addToWatchlist = (sessionId: string, data: IAddToWatchlist) =>
  exec(`account/id/watchlist?session_id=${sessionId}`, Method.POST, {}, data);
